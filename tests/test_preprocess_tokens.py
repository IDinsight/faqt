...
from faqt.preprocessing.tokens import get_ngrams, remove_stop_words, \
    connect_phrases, CustomHunspell
...
class TestIncludingStopWords:
    ...
    def test_reincluded_stop_word(self, sentence, stop_words_to_add_back, expected):
        ...
        """
        assert remove_stop_words(sentence, reincluded_stop_words=stop_words_to_add_back) == \
               expected
...
class TestCustomHunspell:
    ...
    def test_custom_spell_correct_overrides_priority_word(self):
        spell_correct_map = {'chils': 'chills', }
        huns = CustomHunspell(
              custom_spell_correct_map=spell_correct_map,
